class ArtifactsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @artifact.save
        format.html { redirect_to project_path(artifact_params[:project_id]), notice: "Artifact was successfully created." }
  ...
  private
    ...
    def artifact_params
      params.require(:artifact).permit(:name, :project_id)
    end
end
