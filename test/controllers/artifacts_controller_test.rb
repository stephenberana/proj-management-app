...
class ArtifactsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create artifact" do
    assert_difference('Artifact.count') do
      post artifacts_url, params: { artifact: { name: @artifact.name, project_id: @artifact.project_id } }
    end
  ...
  test "should update artifact" do
    patch artifact_url(@artifact), params: { artifact: { name: @artifact.name, project_id: @artifact.project_id } }
